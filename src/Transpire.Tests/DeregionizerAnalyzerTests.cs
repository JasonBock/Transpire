...
internal static class DeregionizerAnalyzerTests
{
	...
	public static void VerifySupportedDiagnostics()
	{
		...
		Assert.Multiple(() =>
		{
			...
			Assert.That(diagnostic.Id, Is.EqualTo(DeregionizeDescriptor.Id),
			...
			Assert.That(diagnostic.HelpLinkUri, Is.EqualTo(HelpUrlBuilder.Build(DeregionizeDescriptor.Id, DeregionizeDescriptor.Title)),
