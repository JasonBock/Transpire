...
internal static class EqualityAnalyzerTests
{
	...
	[Test]
	public static async Task AnalyzeWhenOrderedExistsAndEqualityDoesNotUsingPropertyAsync()
	{
		var code =
			"""
			using Transpire;
	...
	[Test]
	public static async Task AnalyzeWhenExcludedExistsAndEqualityDoesNotUsingConstructorAsync()
	{
		var code =
			"""
			using Transpire;
	...
	[Test]
	public static async Task AnalyzeWhenExcludedExistsAndEqualityDoesNotUsingPropertyAsync()
	{
		var code =
			"""
			using Transpire;
